<style type="text/css">
        .actadmin .compass .nav-tabs{
            background:none;
            border-bottom:0px;
        }

        .actadmin .compass .nav-tabs > li{
            margin-bottom:-1px !important;
        }

        .actadmin .compass .nav-tabs a{
            text-align: center;
            font-size: 10px;
            font-weight: normal;
            background: #f8f8f8;
        ...
        #gradient_bg{
            ...
            top: 61px;
            left: 0px;
            background-image: url(/vendor/act/actadmin/assets/images/bg.jpg);
        ...
        .actadmin .compass .nav-tabs > li > a:hover{
        ...
        .actadmin-link span.resource_label{
            text-align: center;
            color: #fff;
            display: block;
            position: absolute;
        ...
        .actadmin-link span.resource_label:hover{
            opacity:1;
        }
        ...
        .actadmin-link span.resource_label:hover i{
            
            opacity:1;
            transition:all 0.3s linear;
        }

        .actadmin-link span.copy{
            position: absolute;
            font-size: 16px;
            left: 0px;
            bottom: 70px;
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#b3111111', endColorstr='#b3111117',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */
        ...
        .actadmin #logs .table>thead>tr>th:first-child{
            border-top-left-radius: 3px;
        }

        .actadmin #logs .table>thead>tr>th:last-child{
            border-top-right-radius: 3px;
        }
