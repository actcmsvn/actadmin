...
@section('content')
    <div class="page-content">
        ...
        @include('Actadmin::dimmers')
        <div class="analytics-container">
            <?php $google_analytics_client_id = Actadmin::setting("admin.google_analytics_client_id"); ?>
            @if (isset($google_analytics_client_id) && !empty($google_analytics_client_id))
                {{-- Google Analytics Embed --}}
                <div id="embed-api-auth-container"></div>
            @else
                <p style="border-radius:4px; padding:20px; background:#fff; margin:0; color:#999; text-align:center;">
                    {!! __('Actadmin::analytics.no_client_id') !!}
            ...
            <div class="Dashboard Dashboard--full" id="analytics-dashboard">
                <header class="Dashboard-header">
                    <ul class="FlexGrid">
                        <li class="FlexGrid-item">
                            <div class="Titles">
                                <h1 class="Titles-main" id="view-name">{{ __('Actadmin::analytics.select_view') }}</h1>
                                <div class="Titles-sub">{{ __('Actadmin::analytics.various_visualizations') }}</div>
                            </div>
                        </li>
                ...
                <ul class="FlexGrid FlexGrid--halves">
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('Actadmin::analytics.this_vs_last_week') }}</h1>
                                <div class="Titles-sub">{{ __('Actadmin::analytics.by_users') }}</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('Actadmin::analytics.this_vs_last_year') }}</h1>
                                <div class="Titles-sub">{{ __('Actadmin::analytics.by_users') }}</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('Actadmin::analytics.top_browsers') }}</h1>
                                <div class="Titles-sub">{{ __('Actadmin::analytics.by_pageview') }}</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('Actadmin::analytics.top_countries') }}</h1>
                                <div class="Titles-sub">{{ __('Actadmin::analytics.by_sessions') }}</div>
                            </header>
        ...
        <script>
            ...
            gapi.analytics.ready(function () {
                ...
                var viewSelector = new gapi.analytics.ext.ViewSelector2({
                    ...
                    propertyId: '{{ Actadmin::setting("site.google_analytics_tracking_id")  }}'
                })
                        .execute();
                ...
                function renderWeekOverWeekChart(ids) {
                    ...
                    Promise.all([thisWeek, lastWeek]).then(function (results) {
                        ...
                        var data = {
                            ...
                            datasets: [
                                {
                                    label: '{{ __('Actadmin::date.last_week') }}',
                                ...
                                {
                                    label: '{{ __('Actadmin::date.this_week') }}',
                ...
                function renderYearOverYearChart(ids) {
                    ...
                    Promise.all([thisYear, lastYear]).then(function (results) {
                        ...
                        var data = {
                            ...
                            datasets: [
                                {
                                    label: '{{ __('Actadmin::date.last_year') }}',
                                    fillColor: 'rgba(220,220,220,0.5)',
                                    strokeColor: 'rgba(220,220,220,1)',
                                    data: data2
                                },
                                {
                                    label: '{{ __('Actadmin::date.this_year') }}',
                                    fillColor: 'rgba(151,187,205,0.5)',
                                    strokeColor: 'rgba(151,187,205,1)',
                                    data: data1
                                }
