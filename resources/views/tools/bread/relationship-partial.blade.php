...
<div class="row row-dd row-dd-relationship">
    <div class="col-xs-2">
        <h4><i class="actadmin-heart"></i><strong>{{ $relationship->display_name }}</strong></h4>
        <div class="handler actadmin-handle"></div>
        <strong>{{ __('Actadmin::database.type') }}:</strong> <span>{{ __('Actadmin::database.relationship.relationship') }}</span>
        <div class="handler actadmin-handle"></div>
    ...
    <div class="col-xs-2">
        ...
        <label for="field_browse_{{ $relationship['field'] }}"> {{ __('Actadmin::database.relationship.browse') }}</label><br>
        ...
        <label for="field_read_{{ $relationship['field'] }}"> {{ __('Actadmin::database.relationship.read') }}</label><br>
        ...
        <label for="field_edit_{{ $relationship['field'] }}"> {{ __('Actadmin::database.relationship.edit') }}</label><br>
        ...
        <label for="field_add_{{ $relationship['field'] }}"> {{ __('Actadmin::database.relationship.add') }}</label><br>
        ...
        <label for="field_delete_{{ $relationship['field'] }}"> {{ __('Actadmin::database.relationship.delete') }}</label><br>
    </div>
    <div class="col-xs-2">
        <p>{{ __('Actadmin::database.relationship.relationship') }}</p>
    </div>
    <div class="col-xs-2">
    ...
    <div class="col-xs-4">
        <div class="actadmin-relationship-details-btn">
            <i class="actadmin-angle-down"></i><i class="actadmin-angle-up"></i> 
            <span class="open_text">{{ __('Actadmin::database.relationship.open') }}</span>
            <span class="close_text">{{ __('Actadmin::database.relationship.close') }}</span>
            {{ __('Actadmin::database.relationship.relationship_details') }}
        </div>
    </div>
    <div class="col-md-12 actadmin-relationship-details">
        <a href="{{ route('actadmin.bread.delete_relationship', $relationship['id']) }}" class="delete_relationship"><i class="actadmin-trash"></i> {{ __('Actadmin::database.relationship.delete') }}</a>
        <div class="relationship_details_content">
            ...
            <select class="relationship_type select2" name="relationship_type_{{ $relationship['field'] }}">
                <option value="hasOne" @if(isset($relationshipDetails->type) && $relationshipDetails->type == 'hasOne'){{ 'selected="selected"' }}@endif>{{ __('Actadmin::database.relationship.has_one') }}</option>
                <option value="hasMany" @if(isset($relationshipDetails->type) && $relationshipDetails->type == 'hasMany'){{ 'selected="selected"' }}@endif>{{ __('Actadmin::database.relationship.has_many') }}</option>
                <option value="belongsTo" @if(isset($relationshipDetails->type) && $relationshipDetails->type == 'belongsTo'){{ 'selected="selected"' }}@endif>{{ __('Actadmin::database.relationship.belongs_to') }}</option>
                <option value="belongsToMany" @if(isset($relationshipDetails->type) && $relationshipDetails->type == 'belongsToMany'){{ 'selected="selected"' }}@endif>{{ __('Actadmin::database.relationship.belongs_to_many') }}</option>
            </select>
            ...
            <span><input type="text" class="form-control" name="relationship_model_{{ $relationship['field'] }}" placeholder="{{ __('Actadmin::database.relationship.namespace') }}" value="@if(isset($relationshipDetails->model)){{ $relationshipDetails->model }}@endif"></span>
        </div>
            <div class="relationshipField">
                <div class="relationship_details_content margin_top belongsTo @if($relationshipDetails->type == 'belongsTo'){{ 'flexed' }}@endif">
                    <label>{{ __('Actadmin::database.relationship.which_column_from') }} <span>{{ str_singular(ucfirst($table)) }}</span> {{ __('Actadmin::database.relationship.is_used_to_reference') }} <span class="label_table_name"></span>?</label>
                ...
                <div class="relationship_details_content margin_top hasOneMany @if($relationshipDetails->type == 'hasOne' || $relationshipDetails->type == 'hasMany'){{ 'flexed' }}@endif">
                    <label>{{ __('Actadmin::database.relationship.which_column_from') }} <span class="label_table_name"></span> {{ __('Actadmin::database.relationship.is_used_to_reference') }} <span>{{ str_singular(ucfirst($table)) }}</span>?</label>
        ...
        <div class="relationship_details_content margin_top relationshipPivot @if($relationshipDetails->type == 'belongsToMany'){{ 'visible' }}@endif">
            <label>{{ __('Actadmin::database.relationship.pivot_table') }}:</label>
        ...
        <div class="relationship_details_content margin_top">
            <label>{{ __('Actadmin::database.relationship.display_the') }} <span class="label_table_name"></span></label>
            ...
            <label class="relationship_key" style="@if($relationshipDetails->type == 'belongsTo' || $relationshipDetails->type == 'belongsToMany'){{ 'display:block' }}@endif">{{ __('Actadmin::database.relationship.store_the') }} <span class="label_table_name"></span></label>
            ...
            @isset($relationshipDetails->taggable)
                <label class="relationship_taggable" style="@if($relationshipDetails->type == 'belongsToMany'){{ 'display:block' }}@endif">
                    {{__('Actadmin::database.relationship.allow_tagging')}}
                </label>
                <span class="relationship_taggable" style="@if($relationshipDetails->type == 'belongsToMany'){{ 'display:block' }}@endif">
                    <input type="checkbox" name="relationship_taggable_{{ $relationship['field'] }}" class="toggleswitch" data-on="{{ __('Actadmin::generic.yes') }}" data-off="{{ __('Actadmin::generic.no') }}" {{$relationshipDetails->taggable == 'on' ? 'checked' : ''}}>
                </span>
            @endisset
        </div>
    </div>
