...
require('./Actadmin_tinymce');
require('./Actadmin_ace_editor');
...
$(document).ready(function () {
    ...
    $(".hamburger, .navbar-expand-toggle").on('click', function () {
        ...
        if ($(this).hasClass('is-active')) {
            window.localStorage.setItem('actadmin.stickySidebar', true);
        } else {
            window.localStorage.setItem('actadmin.stickySidebar', false);
        }
    });
    ...
    $(document).on('click', '.panel-heading a.panel-action[data-toggle="panel-collapse"]', function (e) {
        ...
        if (!$this.hasClass('panel-collapsed')) {
            ...
            $this.removeClass('actadmin-angle-up').addClass('actadmin-angle-down');
        } else {
            $this.parents('.panel').find('.panel-body').slideDown();
            $this.removeClass('panel-collapsed');
            $this.removeClass('actadmin-angle-down').addClass('actadmin-angle-up');
        }
    });
    ...
    $(document).on('click', '.panel-heading a.panel-action[data-toggle="panel-fullscreen"]', function (e) {
        e.preventDefault();
        var $this = $(this);
        if (!$this.hasClass('actadmin-resize-full')) {
            $this.removeClass('actadmin-resize-small').addClass('actadmin-resize-full');
        } else {
            $this.removeClass('actadmin-resize-full').addClass('actadmin-resize-small');
        }
