...
trait ActadminUser
{
    ...
    {
        return $this->belongsTo(Actadmin::modelClass('Role'));
    }
    ...
    {
        return $this->belongsToMany(Actadmin::modelClass('Role'), 'user_roles');
    }
    ...
    {
        $role = Actadmin::model('Role')->where('name', '=', $name)->first();
