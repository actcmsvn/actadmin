...
use ACT\Actadmin\Http\Controllers\ContentTypes\Checkbox;
use ACT\Actadmin\Http\Controllers\ContentTypes\Coordinates;
use ACT\Actadmin\Http\Controllers\ContentTypes\File;
use ACT\Actadmin\Http\Controllers\ContentTypes\Image as ContentImage;
use ACT\Actadmin\Http\Controllers\ContentTypes\MultipleImage;
use ACT\Actadmin\Http\Controllers\ContentTypes\Password;
use ACT\Actadmin\Http\Controllers\ContentTypes\Relationship;
use ACT\Actadmin\Http\Controllers\ContentTypes\SelectMultiple;
use ACT\Actadmin\Http\Controllers\ContentTypes\Text;
use ACT\Actadmin\Http\Controllers\ContentTypes\Timestamp;
use ACT\Actadmin\Traits\AlertsMessages;
use Validator;
...
abstract class Controller extends BaseController
{
    ...
    {
        if (Storage::disk(config('actadmin.storage.disk'))->exists($path)) {
            Storage::disk(config('actadmin.storage.disk'))->delete($path);
