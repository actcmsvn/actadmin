...
class ControllersCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'Actadmin:controllers';
     ...
     * @var string
     */
    protected $description = 'Publish all the controllers from actadmin.';
    ...
    {
        $stub = $this->getStub();
        $files = $this->filesystem->files(base_path('vendor/act/actadmin/src/Http/Controllers'));
        $namespace = config('actadmin.controllers.namespace', 'ACT\\Actadmin\\Http\\Controllers');
        ...
        $this->info('Published Actadmin controllers!');
    }
    ...
    {
        return $this->filesystem->get(base_path('/vendor/act/actadmin/stubs/'.$this->stub));
    }
    ...
    protected function generateContent($stub, $class)
    {
        ...
        $content = str_replace(
            'FullBaseDummyClass',
            'ACT\\Actadmin\\Http\\Controllers\\'.$class,
            $content
        );
