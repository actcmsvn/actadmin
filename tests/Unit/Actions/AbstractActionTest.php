...
namespace ACT\Actadmin\Tests\Unit\Actions;

use ACT\Actadmin\Actions\AbstractAction;
...
class AbstractActionTest extends TestCase
{
     ...
     *
     * @var \ACT\Actadmin\Models\DataType
     */
    ...
    public function setUp()
    {
        ...
        $this->userDataType = Actadmin::model('DataType')->where('name', 'users')->first();
