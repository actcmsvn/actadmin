...
use ACT\Actadmin\Translator\Collection;
...
class MultilingualTest extends TestCase
{
    public function setUp()
    {
        ...
        config()->set('actadmin.multilingual.locales', ['en', 'da']);

        // Turn on multilingual
        config()->set('actadmin.multilingual.enabled', true);
    }

    public function testCheckingModelIsTranslatable()
    {
        $this->assertTrue(Actadmin::translatable(TranslatableModel::class));
        $this->assertTrue(Actadmin::translatable(ActuallyTranslatableModel::class));
    }

    public function testCheckingModelIsNotTranslatable()
    {
        $this->assertFalse(Actadmin::translatable(NotTranslatableModel::class));
        $this->assertFalse(Actadmin::translatable(StillNotTranslatableModel::class));
    }
