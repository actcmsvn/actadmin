...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify Actadmin user configs
    |
    */
    ...
    'user' => [
        ...
        // However make sure the appointed class must ready to use before installing actadmin.
        // Otherwise `php artisan actadmin:install` will fail with class not found error.
        'namespace'                    => null,
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Path to the Actadmin Assets
    |--------------------------------------------------------------------------
    |
    | Here you can specify the location of the Actadmin assets path
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify Actadmin database settings
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify if you want Actadmin to ship with support for
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When a change happens on Actadmin, we can automate some routines.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you change some of the Actadmin UI settings.
    |
    */
