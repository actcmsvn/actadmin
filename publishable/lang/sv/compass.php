...
return [
    'welcome'           => 'Välkommen till Actadmin Compass. Alla bra appar behöver in kompass som visar riktningen.
    I denna avdelning hittar du resurser som hjälper dig att bygga din applikation',
    'links' => [
        'title'                 => 'Länkar',
        'documentation'         => 'Dokumentation',
        'Actadmin_homepage'      => 'Actadmin Hemsida',
        'Actadmin_hooks'         => 'Actadmin Hooks',
    ],
    'commands' => [
        'title'                 => 'Kommandon',
        'text'                  => 'Kör Artisan Kommandon från actadmin.',
    ...
    'resources' => [
        'title'                 => 'Resurser',
        'text'                  => 'Actadmin resurser som hjälper dig hitta snabbare.',
    ],
    'logs' => [
        'title'                 => 'Loggar',
    ...
    'fonts' => [
        'title'                 => 'Typsnitt',
        'font_class'            => 'Actadmin Typsnitt Klasser',
        'font_character'        => 'Actadmin Typsnitt Tecken',
    ],
];
