...
return [
    'welcome'                => 'Bienvenue sur Actadmin Compass. Chaque bonne nouvelle application ont besoin d\'une boussole pour se diriger dans la bonne direction.
    Dans cette section, vous trouverez plusieurs ressources et tâches administrative afin de vous guider lors de la création de votre application',
        ...
        'Welcome to the Actadmin Compass. Every good app needs a compass to point them in the right direction.
    ...
    'links'         => [
        ...
        'Actadmin_homepage'      => 'Actadmin Homepage',
        'Actadmin_hooks'         => 'Actadmin Hooks',
    ],
    'commands'      => [
        'title'                 => 'Commandes',
        'text'                  => 'Lancer les Commandes artisan depuis actadmin.',
    ...
    'resources'     => [
        'title'                 => 'Resources',
        'text'                  => 'Ressources Actadmin pour vous aider a rechercher certaines chose plus vite.',
    ...
    'fonts'         => [
        ...
        'font_class'            => 'Classe de correspondance à la police Actadmin',
        'font_character'        => 'Charactère de correspondance à la police Actadmin',
    ],
];
