...
return [
    'welcome'                => '
    به قطب نمای Actadmin خوش آمدید! هر اپلیکیشن خوب باید یک قطب نما داشته باشد که کاربران را به جهات صحیح هدایت کند!.
    ...
    'links'         => [
        ...
        'Actadmin_homepage'      => 'صفحه اصلی Actadmin',
        'Actadmin_hooks'         => 'هوک های Actadmin',
    ],
    'commands'      => [
        'title'                 => 'دستورات',
        'text'                  => 'اجرای دستورات Artisan از Actadmin',
    ...
    'resources'     => [
        'title'                 => 'منابع',
        'text'                  => 'منابع Actadmin برای کمک به شما جهت یافتن سریع تر آنچه به دنبالش هستید',
    ...
    'fonts'         => [
        'title'                 => 'فونت ها',
        'font_class'            => 'نقشه کلاس های فونت Actadmin',
        'font_character'        => 'نقشه کاراکترهای فونت Actadmin',
    ],
];
