...
return [
    'welcome'                => 'Добро пожаловать в Actadmin Compass. Каждое хорошее приложение нуждается в компасе, чтобы указать им в правильном направлении.
     В этом разделе вы найдете много ресурсов и административных задач, которые помогут вам в создании вашего приложения.',
    'links'         => [
        'title'                 => 'Ссылки',
        'documentation'         => 'Документация',
        'Actadmin_homepage'      => 'Страница Actadmin',
        'Actadmin_hooks'         => 'Хуки Actadmin',
    ],
    'commands'      => [
        'title'                 => 'Команды',
        'text'                  => 'Запустите команду Artisan от actadmin.',
    ...
    'resources'     => [
        'title'                 => 'Ресурсы',
        'text'                  => 'Ресурсы Actadmin, которые помогут вам найти вещи быстрее.',
    ...
    'fonts'         => [
        'title'                 => 'Шрифты',
        'font_class'            => 'Карта классов шрифта Actadmin',
        'font_character'        => 'Карта символов шрифта Actadmin',
    ],
];
