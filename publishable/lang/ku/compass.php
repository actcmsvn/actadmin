...
return [
    'welcome'                => 'بەخێربێیت بۆ قیبلەنمای ڤۆیەیجەر (Actadmin). هەموو ئەپڵیکەیشنێک پێویستی بە قیبلەنمایەکە بۆ نیشاندانی ڕێی ڕاست.
    ...
    'links'         => [
        ...
        'Actadmin_homepage'      => 'پەڕەی سەرەتای ڤۆیەیجەر (Actadmin)',
        'Actadmin_hooks'         => 'هووکەکانی ڤۆیەیجەر (Actadmin)',
    ],
    'commands'      => [
        'title'                 => 'ناونیشان',
