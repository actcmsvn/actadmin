...
class PagesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if (!$dataType->exists) {
            $dataType->fill([
                'name'                  => 'pages',
                'display_name_singular' => __('Actadmin::seeders.data_types.page.singular'),
                'display_name_plural'   => __('Actadmin::seeders.data_types.page.plural'),
                'icon'                  => 'actadmin-file-text',
                'model_name'            => 'ACT\\Actadmin\\Models\\Page',
                'controller'            => '',
        ...
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'image',
                'display_name' => __('Actadmin::seeders.data_rows.page_image'),
                'required'     => 0,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $menuItem = MenuItem::firstOrNew([
            'menu_id' => $menu->id,
            'title'   => __('Actadmin::seeders.menu_items.pages'),
            'url'     => '',
